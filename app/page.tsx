    ...
    >
      ...
      <div className="flex flex-1 flex-col items-center justify-start px-6 pb-20 pt-16">
        ...
        <p className="text-[22px] font-medium leading-none text-foreground" style={{ fontFamily: "var(--font-overused-grotesk)" }}>
          <TextScramble text="Hi, I'm Shakib, Product Design Engineer." />
        </p>

        <p className="mt-4 max-w-[540px] text-[15px] leading-relaxed text-neutral-700 dark:text-neutral-300">
        ...
        <p className="mt-3 max-w-[540px] text-[15px] leading-relaxed text-neutral-700 dark:text-neutral-300">
